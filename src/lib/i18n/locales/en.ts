const en = {
  ...
  address: {
    ...
    phone: 'Phone Number',
    addressLine: 'Address (house no, street, ward)',
    street: 'Address (house no, street, ward)',
    ward: 'Ward / Commune',
    city: 'City / Province',
    save: 'Save Address',
  ...
  admin: {
    ...
    dashboard: {
      ...
      returningThisWeek:   'Returning this week',
      users:               'users',
      orders:          'Orders',
      returnOrders:    'Return Requests',
  ...
  notification: {
    ...
    NEW_RETURN_REQUEST: {
      ...
      message: 'Order #{{orderCode}} — {{customerName}} has submitted a return request',
    },
    NEW_CONTACT_MESSAGE: {
      title:   'New Message',
      message: '{{senderName}} sent: {{topic}}',
    },
  },
  ...
  checkout: {
    ...
    district:          'District',           // legacy key — kept for backward compat
    districtPh:        'Enter district',      // legacy
    ward:              'Ward',
    wardPh:            'Enter ward',
    address:           'Address (house no, street, ward)',
  ...
  adminFlashSales: {
    ...
    subtitle:     'Time-limited promotions — auto-activate on schedule',
    statActive:   'Active',
    statScheduled:'Scheduled',
    statSold:     'Total Sold',
    createBtn:    'Create Flash Sale',
    ...
    emptyCreate:  'Create your first flash sale',
    remaining:    '{{remaining}} left · {{sold}} sold',
    ...
    form: {
      createTitle: 'Create New Flash Sale',
      editTitle:   'Update Flash Sale',
      productId:   'Product ID *',
      productIdPh: 'Product UUID',
      salePrice:   'Sale Price (₫) *',
      stockLimit:  'Stock Limit *',
      startTime:   'Start time *',
      endTime:     'End time *',
      saveBtn:     'Create Flash Sale',
      updateBtn:   'Update',
      cancel:      'Cancel',
    },
    toast: {
      created:     'Flash sale created',
      updated:     'Flash sale updated',
      deleted:     'Flash sale deleted',
      deleteFailed:'Only SCHEDULED flash sales can be deleted',
      loadFailed:  'Failed to load flash sales',
      error:       'An error occurred. Please try again.',
    },
    validation: {
      productIdRequired: 'Product ID is required',
      salePriceMin:      'Sale price must be > 0',
  ...
  adminInventory: {
    ...
    subtitle:     'Goods receipts / issues — stock updates immediately',
    statTotal:    'Total Vouchers',
    statImport:   'Imports',
    statExport:   'Exports',
    createBtn:    'Create Voucher',
    tableTitle:   'Inventory Vouchers',
    colCode:      'Code',
    colType:      'Type',
    ...
    colDate:      'Date',
    colDetail:    'Detail',
    emptyTitle:   'No inventory vouchers yet',
    emptyCreate:  'Create your first voucher',
    ...
    form: {
      title:      'Create Inventory Voucher',
      typeLabel:  'Voucher type *',
      noteLabel:  'Note',
      notePh:     'Enter note (optional)',
      itemsLabel: 'Product list *',
      addLine:    'Add line',
    ...
    toast: {
      loadFailed:    'Failed to load inventory vouchers',
      createSuccess: 'Voucher {{code}} created — stock updated',
      createFailed:  'Failed to create voucher. Check Product IDs and stock.',
      detailFailed:  'Failed to load voucher detail',
    },
    validation: {
      minOneItem:       'At least 1 item is required',
      productIdRequired:'Row {{n}}: Product ID is required',
      quantityMin:      'Row {{n}}: Minimum quantity is 1',
      unitPriceInvalid: 'Row {{n}}: Invalid unit price',
    },
  },
  ...
  adminReviews: {
    ...
    selectAll:   'Select {{count}} pending',
    deselectAll: 'Deselect all',
    reply: {
      from:        'Shop Reply',
      edit:        'Edit',
      delete:      'Delete',
      addPrompt:   'Add Shop reply...',
      placeholder: 'Enter Shop reply...',
      cancel:      'Cancel',
      send:        'Send',
      sending:     'Saving...',
      saved:       'Reply saved',
    ...
    toast: {
      ...
      bulkApproved: '{{count}} reviews approved',
      bulkRejected: '{{count}} reviews rejected',
  ...
  adminChat: {
    ...
    roomClosed:        'Chat room closed',
    noMessages:        'No messages yet',
    inputPh:           'Reply to customer...',
    status: {
      OPEN:   'Open',
      CLOSED: 'Closed',
    },
    toast: {
      ...
      msgLoadFailed: 'Failed to load messages',
      sendFailed:    'Send failed',
      closedSuccess: 'Chat room closed',
      closeFailed:   'Failed to close chat room',
    },
  },
  ...
  adminReturns: {
    ...
    searchPh:     'Search by order code, customer...',
    exportExcel:  'Export Excel',
    exportSuccess:'Return/Exchange Excel exported',
    refresh:      'Refresh',
    ...
    detail: {
      ...
      evidence: 'Evidence Images ({{count}})',
      note:     'Staff Note',
      close:    'Close',
    },
    noteModal: {
      approveTitle:   'Confirm Approve Return Request',
      rejectTitle:    'Reject Return Request',
      approvePh:      'Approval note (optional)...',
      rejectPh:       'Reason for rejection (required)...',
      cancel:         'Cancel',
      confirmApprove: 'Confirm Approve',
      confirmReject:  'Confirm Reject',
      rejectRequired: 'Please enter rejection reason',
    },
    toast: {
  ...
  adminVouchers: {
    ...
    statActive:   'Active',
    statInactive: 'Inactive',
    tableTitle:   'Voucher List',
    searchPh:     'Search by code, voucher name...',
    createBtn:    'Create voucher',
    noLimit:      'Unlimited',
    deleteConfirm:'Are you sure you want to delete this voucher? This cannot be undone.',
    minOrder:     '≥ {{amount}}',
    ...
    empty: {
      ...
      desc:  'Click "+ Create voucher" to add a new one',
    },
    form: {
      ...
      codePh:       'E.g.: SUMMER20',
      name:         'Voucher name *',
      namePh:       'E.g.: Summer discount',
      discountType: 'Discount type',
      pct:          'Percentage (%)',
      fixed:        'Fixed amount',
      valuePct:     'Discount (%) *',
      valueFixed:   'Discount (₫) *',
      maxAmount:    'Max discount (₫)',
      maxAmountPh:  'Unlimited',
      minOrder:     'Min order (₫)',
      usageLimit:   'Max uses',
      usageLimitPh: 'Unlimited',
    ...
    toast: {
      ...
      toggled:  'Voucher status updated',
      deleted:  'Voucher deleted',
      error:    'Error',
      errorDel: 'Error deleting voucher',
    },
    validation: {
      codeRequired:  'Please enter voucher code',
      nameRequired:  'Please enter voucher name',
      valueMin:      'Discount value must be > 0',
      valuePctMax:   'Percentage cannot exceed 100',
  ...
  adminBlog: {
    ...
    form: {
      ...
      thumbnailPh: 'https://...',
      excerpt:     'Excerpt',
      excerptPh:   'Short description for listing page...',
      content:     'Content *',
      contentPh:   'Post content...',
      metaTitle:   'Meta Title (SEO)',
      metaTitlePh: 'SEO title...',
      metaDesc:    'Meta Description (SEO)',
      metaDescPh:  'SEO description...',
      publishNow:  'Publish now',
      saveDraft:   'Save as draft',
      pubDesc:     'Post will be publicly visible',
      draftDesc:   'Post visible to admin only',
      cancel:      'Cancel',
      create:      'Create post',
      save:        'Save changes',
    },
    ...
    toast: {
      ...
      drafted:      'Moved to drafts',
      published:    'Published',
      deleted:      'Post deleted',
      deleteFailed: 'Delete failed — check admin permissions',
    },
    confirm: {
